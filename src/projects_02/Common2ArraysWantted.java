 ...
 * @author CEL�L
 */
public class Common2ArraysWantted {
...
if (array2[array2.length-1]==array1[array1.length-1]) {
	System.out.println("Girilen degerlerin olusturdugu  iki farkli arrayda son elemanlar  ortak");
}else if (array2[0]==array1[0]) {
	System.out.println("Girilen degerlerin olusturdugu  iki farkli arrayda ilk elemanlar  ortak");
} else {
	System.out.println("Girilen degerlerin olusturdugu  iki farkli arrayda ilk veya son elemanlar ortak degil");
}
